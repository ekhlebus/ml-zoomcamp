...
This repository contains a project focused on **predicting car prices** using machine learning techniques.  
...
👉 [Car Dataset — by CooperUnion](https://www.kaggle.com/datasets/CooperUnion/cardataset)

After downloading, place the file in the project’s `data/` directory.